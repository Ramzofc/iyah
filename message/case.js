...
var Ownerin ="6281356860691@s.whatsapp.net"
var ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`6281356860691@s.whatsapp.net`,`${conn.user.jid}`]
...
YouTube:`https://youtube.com/skyzxdd`
}
}
...
if (isGroupAdmins) return setReply('Lu Admin Lu Aman')
if(ownerNumber.includes(sender)) return setReply('Lu Owner Bot Lu Aman')
let linkgc = await conn.groupInviteCode(from)
if (budy.includes(`${linkgc}`)) return reply ('Wuanjir kirain link grup lain, huh hampir aja kena kick 😆')
if (budy.includes('zin admin') || budy.includes('zinmin') )return setReply('Izin Admin diterima')
...
let muk = [{urlButton: {displayText: `Sewa`,url: `https://wa.me/p/8960486383991478/6281356860691`}}]
...
let muk = [{urlButton: {displayText: `ORDER`,url: `https://wa.me/p/5494819543894101/6281356860691`}}]
let teks = `*BROADCAST GROUP*\n\n${q}`
...
case 'ytmp4':
try{
if (q.includes("https://youtube.com/channel/")) return setReply("Link tersebut bukan link video")
setReply("*Scrapping...*")
...
previewType:"PHOTO",
thumbnail: fs.readFileSync('./stik/reply.jpg'),
sourceUrl:`https://chat.whatsapp.com/GBAnC7GUNSF3XMFMLcABYD`
}}, video: vid, caption: "*Nih Tutornya🗿*", mimetype: 'video/mp4' },{quoted: m})

let repli = `*_Tunggu, sedang mengirim video TUTORIAL runn bot_*`

let repli2 = `*join grup panel murmer*\n\nhttps://chat.whatsapp.com/GBAnC7GUNSF3XMFMLcABYD`
